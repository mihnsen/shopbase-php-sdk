...
use Shopbase\Service\AbstractService;

abstract class AbstractApi implements ApiInterface
{
    const DEFAULT_API_VERSION = ''; // Shopbase does not have api version for now

    /**
     * Domain of the Shopbase store
     *
     * @var string
     */
    protected $onshopbase_domain;
     ...
     * @return $this
     */
    public function setOnshopbaseDomain($domain)
    {
        $this->onshopbase_domain = $domain;
        $this->init();
        return $this;
    }
